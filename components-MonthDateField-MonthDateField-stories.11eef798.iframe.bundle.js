"use strict";(self.webpackChunk_carlospence_synccomponents_test=self.webpackChunk_carlospence_synccomponents_test||[]).push([[698],{"./src/components/MonthDateField/MonthDateField.stories.tsx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{Default:()=>Default,__namedExportsOrder:()=>__namedExportsOrder,default:()=>MonthDateField_stories});__webpack_require__("./node_modules/react/index.js");var formik_esm=__webpack_require__("./node_modules/formik/dist/formik.esm.js"),CustomField=__webpack_require__("./src/components/CustomField/CustomField.tsx"),FieldDecoration=__webpack_require__("./src/components/FieldDecoration/FieldDecoration.tsx"),MonthDatePicker=__webpack_require__("./src/components/MonthDatePicker/MonthDatePicker.tsx"),styled_components_browser_esm=__webpack_require__("./node_modules/styled-components/dist/styled-components.browser.esm.js"),jsx_runtime=__webpack_require__("./node_modules/react/jsx-runtime.js");const MonthDateFieldRoot=styled_components_browser_esm.ZP.div.attrs((props=>({className:"react-simple-widget month-date-field "+props.className})))`
  .month-date-picker {
    display: flex;
  }
...
`,MonthDateField=_ref=>{let{name,label,helper,leading,trailing,disabled,onChange,onFocus,onBlur,...rest}=_ref;return(0,jsx_runtime.jsx)(MonthDateFieldRoot,{children:(0,jsx_runtime.jsx)(CustomField.J,{name,children:_ref2=>{let{value,error,touched,setValue,setTouched}=_ref2;return(0,jsx_runtime.jsx)(FieldDecoration.h,{label,leading,trailing,error:touched&&error,helper,disabled,children:_ref3=>{let{onFieldFocus,onFieldBlur}=_ref3;return(0,jsx_runtime.jsx)(MonthDatePicker.w,{value,onChange:date=>{setValue(date),onChange&&onChange(date)},onFocus:e=>{onFieldFocus(),setTouched(!0),onFocus&&onFocus(e)},onBlur:e=>{onFieldBlur(),onBlur&&onBlur(e)},...rest})}})}})})};MonthDateField.displayName="MonthDateField";try{MonthDateField.displayName="MonthDateField",MonthDateField.__docgenInfo={description:"",displayName:"MonthDateField",props:{name:{defaultValue:null,description:"",name:"name",required:!0,type:{name:"string"}},disabled:{defaultValue:null,description:"",name:"disabled",required:!1,type:{name:"boolean"}},onChange:{defaultValue:null,description:"",name:"onChange",required:!1,type:{name:"((date: string) => void)"}},validator:{defaultValue:null,description:"",name:"validator",required:!1,type:{name:"((date: string) => string)"}},label:{defaultValue:null,description:"",name:"label",required:!1,type:{name:"any"}},leading:{defaultValue:null,description:"",name:"leading",required:!1,type:{name:"Element"}},trailing:{defaultValue:null,description:"",name:"trailing",required:!1,type:{name:"Element"}},helper:{defaultValue:null,description:"",name:"helper",required:!1,type:{name:"any"}}}},"undefined"!=typeof STORYBOOK_REACT_CLASSES&&(STORYBOOK_REACT_CLASSES["src/components/MonthDateField/MonthDateField.tsx#MonthDateField"]={docgenInfo:MonthDateField.__docgenInfo,name:"MonthDateField",path:"src/components/MonthDateField/MonthDateField.tsx#MonthDateField"})}catch(__react_docgen_typescript_loader_error){}var dist=__webpack_require__("./node_modules/@storybook/addon-actions/dist/index.mjs");const MonthDateField_stories={title:"SyncComponents/MonthDateField",component:MonthDateField},Default=()=>{const SampleForm=()=>(0,jsx_runtime.jsx)("div",{id:"sample-form",children:(0,jsx_runtime.jsx)(formik_esm.J9,{initialValues:{field:""},validate:values=>{const errors={};return values.field||(errors.field="Required"),errors},onSubmit:values=>{console.log(values),(0,dist.aD)("Form Submit")(values)},children:formik=>(0,jsx_runtime.jsxs)("form",{onSubmit:formik.handleSubmit,children:[(0,jsx_runtime.jsx)("div",{className:"mb-4",children:(0,jsx_runtime.jsx)(MonthDateField,{name:"field",label:"Month date field",placeholder:"Click to select date",helper:`${formik.values.field.length} of 6`,leading:(0,jsx_runtime.jsx)("i",{className:"fa fa-calendar me-1"})})}),(0,jsx_runtime.jsx)("div",{className:"d-grid",children:(0,jsx_runtime.jsx)("button",{type:"submit",className:"btn btn-primary",children:"Submit"})})]})})});return(0,jsx_runtime.jsx)(SampleForm,{})};Default.displayName="Default",Default.parameters={...Default.parameters,docs:{...Default.parameters?.docs,source:{originalSource:'(): any => {\n  const SampleForm = (): any => {\n    const initialValues: any = {\n      field: ""\n    };\n    const validate = (values: any) => {\n      const errors: any = {};\n      if (!values.field) errors.field = "Required";\n      return errors;\n    };\n    const onSubmit = (values: any) => {\n      console.log(values);\n      action("Form Submit")(values);\n    };\n    return <div id="sample-form">\n        <Formik initialValues={initialValues} validate={validate} onSubmit={onSubmit}>\n          {formik => <form onSubmit={formik.handleSubmit}>\n              <div className="mb-4">\n                <MonthDateField name="field" label="Month date field" placeholder="Click to select date" helper={`${formik.values.field.length} of 6`} leading={<i className="fa fa-calendar me-1" />} />\n              </div>\n\n              <div className="d-grid">\n                <button type="submit" className="btn btn-primary">\n                  Submit\n                </button>\n              </div>\n            </form>}\n        </Formik>\n      </div>;\n  };\n  return <SampleForm />;\n}',...Default.parameters?.docs?.source}}};const __namedExportsOrder=["Default"]},"./src/components/CustomField/CustomField.tsx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{J:()=>CustomField});var formik__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./node_modules/formik/dist/formik.esm.js");const CustomField=_ref=>{let{children,errorBuilder:_errorBuilder,...rest}=_ref;const[field,meta,helper]=(0,formik__WEBPACK_IMPORTED_MODULE_0__.U$)(rest);return children({...field,...meta,...helper,error:(error=>{if(_errorBuilder)return _errorBuilder(error);switch(Object.prototype.toString.call(error)){case"[object Object]":return Object.keys(error).map((k=>error[k])).join(", ");case"[object Array]":return error.join(", ");case"[object String]":return error.toString();default:return""}})(meta.error)})};try{CustomField.displayName="CustomField",CustomField.__docgenInfo={description:"",displayName:"CustomField",props:{errorBuilder:{defaultValue:null,description:"",name:"errorBuilder",required:!1,type:{name:"CustomFieldErrorBuilder"}}}},"undefined"!=typeof STORYBOOK_REACT_CLASSES&&(STORYBOOK_REACT_CLASSES["src/components/CustomField/CustomField.tsx#CustomField"]={docgenInfo:CustomField.__docgenInfo,name:"CustomField",path:"src/components/CustomField/CustomField.tsx#CustomField"})}catch(__react_docgen_typescript_loader_error){}},"./src/components/FieldDecoration/FieldDecoration.tsx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{h:()=>FieldDecoration});var react__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./node_modules/react/index.js"),styled_components__WEBPACK_IMPORTED_MODULE_2__=__webpack_require__("./node_modules/styled-components/dist/styled-components.browser.esm.js"),react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__("./node_modules/react/jsx-runtime.js");const FieldDecorationRoot=styled_components__WEBPACK_IMPORTED_MODULE_2__.ZP.div.attrs((props=>({className:"react-simple-widget field-decoration "+props.className})))`
  &.has-focus {
...
`,MonthDatePicker=_ref=>{let{value,validator,onChange,...rest}=_ref;const[displayYear,setDisplayYear]=(0,react__WEBPACK_IMPORTED_MODULE_0__.useState)((0,_utils_calendarUtils__WEBPACK_IMPORTED_MODULE_1__.gy)(value)),[displayMonth,setDisplayMonth]=(0,react__WEBPACK_IMPORTED_MODULE_0__.useState)((0,_utils_calendarUtils__WEBPACK_IMPORTED_MODULE_1__.fh)(value)),[error,setError]=(0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(""),monthBtnClassName=active=>{const classes=["btn","btn-link","btn-sm","text-decoration-none"];return active&&classes.push("active"),classes.join(" ")},resetDisplayDate=()=>{const current=dayjs__WEBPACK_IMPORTED_MODULE_3___default()();setDisplayYear(current.year()),setDisplayMonth(current.month())};return(0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)((()=>{onChange(dayjs__WEBPACK_IMPORTED_MODULE_3___default()([displayYear,displayMonth,1]).format("YYYY-MM-DD"))}),[displayMonth,displayYear]),(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsxs)(_PopupMenu_PopupMenu__WEBPACK_IMPORTED_MODULE_4__.Z,{children:[(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(MonthDatePickerRoot,{...rest,children:dayjs__WEBPACK_IMPORTED_MODULE_3___default()([displayYear,displayMonth,1]).format("MMMM YYYY")}),closePopup=>(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(MonthDatePickerPopupRoot,{className:"card",children:(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsxs)("div",{className:"card-body",children:[(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsxs)("header",{className:"d-flex justify-content-between align-items-center mb-3",children:[(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)("p",{className:"mb-0",children:"Select Date"}),(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsxs)("button",{type:"button",className:"btn btn-light btn-sm",onClick:resetDisplayDate,children:["⏱"," "]})]}),(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_FieldDecoration_FieldDecoration__WEBPACK_IMPORTED_MODULE_5__.h,{label:"Year",className:"mb-4",children:_ref2=>{let{onFieldFocus,onFieldBlur}=_ref2;return(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)("select",{value:displayYear,className:"year-select",onChange:e=>setDisplayYear(parseInt(e.target.value)),onFocus:onFieldFocus,onBlur:onFieldBlur,children:_utils_calendarUtils__WEBPACK_IMPORTED_MODULE_1__.gQ.map((year=>(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)("option",{value:year,children:year},year)))})}}),(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)("div",{className:"month-select",children:_utils_calendarUtils__WEBPACK_IMPORTED_MODULE_1__.e7.map(((month,monthIndex)=>(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)("button",{type:"button",className:monthBtnClassName(monthIndex===displayMonth),onClick:()=>{if(setDisplayMonth(monthIndex),validator){const selectedDate=dayjs__WEBPACK_IMPORTED_MODULE_3___default()([displayYear,monthIndex,1]).format("YYYY-MM-DD"),error=validator(selectedDate);if(error)return setError(error);setError("")}else setError("");closePopup()},children:month.substring(0,3)},month)))}),error&&(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)("div",{className:"month-date-picker-error",children:error})]})})]})};MonthDatePicker.displayName="MonthDatePicker";try{MonthDatePicker.displayName="MonthDatePicker",MonthDatePicker.__docgenInfo={description:"",displayName:"MonthDatePicker",props:{value:{defaultValue:null,description:"",name:"value",required:!0,type:{name:"string"}},validator:{defaultValue:null,description:"",name:"validator",required:!1,type:{name:"((date: string) => string)"}},onChange:{defaultValue:null,description:"",name:"onChange",required:!0,type:{name:"(date: string) => void"}}}},"undefined"!=typeof STORYBOOK_REACT_CLASSES&&(STORYBOOK_REACT_CLASSES["src/components/MonthDatePicker/MonthDatePicker.tsx#MonthDatePicker"]={docgenInfo:MonthDatePicker.__docgenInfo,name:"MonthDatePicker",path:"src/components/MonthDatePicker/MonthDatePicker.tsx#MonthDatePicker"})}catch(__react_docgen_typescript_loader_error){}},"./src/components/PopupMenu/PopupMenu.tsx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{Z:()=>PopupMenu});var react__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./node_modules/react/index.js"),styled_components__WEBPACK_IMPORTED_MODULE_2__=__webpack_require__("./node_modules/styled-components/dist/styled-components.browser.esm.js"),react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__("./node_modules/react/jsx-runtime.js");const revealOptions=styled_components__WEBPACK_IMPORTED_MODULE_2__.F4`
    from {
      opacity: 0;
      transform: scale(0.5);
    }
